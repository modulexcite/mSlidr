require.config({
	paths: {
    	...
    	socketio:"../scripts/libs/socket.io",
    	...
    	'strut/sync': '../bundles/app/strut.sync',
...
require([
	...
	function(Handlebars, lang, empt, empty, socketio, config, registry, StrutLoader, bootstrap, ContextMenu, css, tp, dss) {
		'use strict';
